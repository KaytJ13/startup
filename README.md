...
- [x] **Backend listens for WebSocket connection** - The backend listens for and handles WebSocket connections.
- [x] **Frontend makes WebSocket connection** - The frontend makes WebSocket connections.
- [x] **Data sent over WebSocket connection** - The messages for the messaging space are sent over the WebSocket.
- [x] **WebSocket data displayed** - The messages are displayed.
